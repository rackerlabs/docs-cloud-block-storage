...
exclude_patterns = ['_build', 'samples', 'extended-api-operations/methods/*', 
                    'mgmt-api-operations/methods', 'reports-api-operations/methods/*','api-operations/methods*']
...
rst_epilog = """
.. |apiservice| replace:: Rackspace Cloud Block Storage API Developer Guide for Service Management
...
#html_title = 'Rackspace Cloud Block Storage API v1.0 Developer Guide for Service Management'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Block Storage API Developer Guide for Service Management'
...
htmlhelp_basename = 'CBSApiAdminDoc'
...
latex_documents = [
  ('index', 'CBSApiAdminDoc.tex', 'Rackspace Cloud Block Storage API Service Managment Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCDNApiDeveloperDoc', 'Rackspace CDN API Admin Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'CBSApiAdminDoc.tex', 'Rackspace Cloud Block Storage API Service Managment Guide',
   'Rackspace', 'docs-cloud-block-storage', 'Learn about using the REST API for the Rackspace Cloud Block Storage service.',
   'Miscellaneous'),
]
