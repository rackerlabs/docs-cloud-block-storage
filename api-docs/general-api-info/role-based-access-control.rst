...
.. list-table:: **Product roles and capabilities**
   ...
   * - cbs:admin
     - This role provides Create, Read, Update, and Delete permissions
       in Cloud Block Storage, where access is granted.
   * - cbs:creator
     - This role provides Create, Read, and Update permissions in Cloud Block
       Storage, where access is granted.
   * - cbs:observer
     - This role provides Read permission in Cloud Block Storage, where access
       is granted.
