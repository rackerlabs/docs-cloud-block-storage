...
project = 'Rackspace Cloud Block Storage'
...
.. |service| replace:: Cloud Block Storage
...
# html_title = 'Rackspace Cloud Block Storage v1.0 API Guide'
...
htmlhelp_basename = 'RackspaceCloudBlockStorageAPIDoc'
...
latex_documents = [
  (master_doc, 'docs-cloud-block-storage.tex',
   'Rackspace Cloud Block Storage API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Block Storage API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-block-storage',
   'Rackspace Cloud Block Storage API Documentation',
   'Rackspace', 'docs-cloud-block-storage', 'Learn about using the Product',
   'Miscellaneous'),
]
