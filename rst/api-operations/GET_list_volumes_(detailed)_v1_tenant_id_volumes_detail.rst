...
`Request <GET_list_volumes_(detailed)_v1_tenant_id_volumes_detail.rst#request>`__
`Response <GET_list_volumes_(detailed)_v1_tenant_id_volumes_detail.rst#response>`__
...
**Example List Volumes (Detailed): XML request**
...
**Example List Volumes (Detailed): JSON request**
