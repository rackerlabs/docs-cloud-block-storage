...
`Request <GET_list_volumes_v1_tenant_id_volumes.rst#request>`__
`Response <GET_list_volumes_v1_tenant_id_volumes.rst#response>`__
...
**Example List Volumes: XML request**
