...
`Request <GET_list_snapshots_(detailed)_v1_tenant_id_snapshots_detail.rst#request>`__
`Response <GET_list_snapshots_(detailed)_v1_tenant_id_snapshots_detail.rst#response>`__
...
**Example List Snapshots (Detailed): XML request**
...
**Example List Snapshots (Detailed): JSON request**
